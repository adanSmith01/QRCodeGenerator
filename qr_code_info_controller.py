...
class QRCodeInfoController():
    ...
    def validate_image_name() -> str:
        ...
        QRCodeInfoController.__validate_text(IMAGE_NAME_INPUT_MESSAGE, IMAGE_NAME_ERROR_MESSAGE)
    ...
    def __validate_hex_color(input_message: str) -> str:
        ...
        while True:
            ...
            try:
                ...
                if len(color) != HEX_CODE_LEN or not all(c in string.hexdigits for c in color): 
                    raise ValueError
    ...
    def validate_logo_path() -> str:
        ...
        while True:
            ...
            logo_path = input(LOGO_PATH_INPUT_MESSAGE)
